...
const Matches = () => {
  ...
  const initialFlights = [
    ...
    { type: 'singles', position: 1, level: 'jv' },
    { type: 'singles', position: 2, level: 'jv' },
    { type: 'doubles', position: 1, level: 'jv' }
  ];
                ...
                {matchFormData.isComplete && (
                  <div className="space-y-2">
                    <Label>
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          checked={matchFormData.homeTeamWon}
                          onCheckedChange={(checked) => 
                            setMatchFormData({ ...matchFormData, homeTeamWon: checked as boolean })
                          }
                        />
                    ...
                    <div className="text-sm text-gray-500">
                      (This can be auto-calculated from individual match results)
                    </div>
                  </div>
                )}
              </div>
              
              {matchFormData.homeTeamId && matchFormData.awayTeamId && (
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium mb-4">Varsity Matches</h3>
                    ...
                    {matchFormData.flights
                      ...
                      .map((flight, flightIndex) => {
                        ...
                        return (
                          <div key={`${flight.type}-${flight.position}-${flight.level}`} className="mb-6 p-4 border rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                              <div>
                                <Label className="mb-1 block">Home Player{flight.type === 'doubles' ? 's' : ''}</Label>
                                {Array.from({ length: flight.type === 'singles' ? 1 : 2 }).map((_, playerIndex) => (
                                  <div key={playerIndex} className="mb-2">
                                    <Select
                                      value={flight.homePlayers[playerIndex] || ''}
                                      onValueChange={(value) => 
                                        handleFlightPlayerChange(actualIndex, 'home', playerIndex, value)
                                      }
                                    >
                                      <SelectTrigger>
                                        <SelectValue placeholder={`Select player ${playerIndex + 1}`} />
                                      </SelectTrigger>
                                      <SelectContent>
                              ...
                              <div>
                                <Label className="mb-1 block">Away Player{flight.type === 'doubles' ? 's' : ''}</Label>
                                {Array.from({ length: flight.type === 'singles' ? 1 : 2 }).map((_, playerIndex) => (
                                  <div key={playerIndex} className="mb-2">
                                    <Select
                                      value={flight.awayPlayers[playerIndex] || ''}
                                      onValueChange={(value) => 
                                        handleFlightPlayerChange(actualIndex, 'away', playerIndex, value)
                                      }
                                    >
                                      <SelectTrigger>
                                        <SelectValue placeholder={`Select player ${playerIndex + 1}`} />
                            ...
                            {matchFormData.isComplete && (
                              <>
                                <div className="mb-2">
                                  <Label className="mb-2 block">Set Scores</Label>
                                  
                                  {flight.sets.map((set, setIndex) => (
                                    <div key={setIndex} className="mb-4 p-3 bg-gray-50 rounded-md">
                                      ...
                                      <div className="grid grid-cols-2 gap-4">
                                        <div>
                                          <Label className="text-sm mb-1 block">Home Score</Label>
                                          <Select
                                            value={set.homeScore.toString()}
                                            onValueChange={(value) => 
                                              handleSetScoreChange(actualIndex, setIndex, 'home', parseInt(value))
                                            }
                                          >
                                            <SelectTrigger>
                                        ...
                                        <div>
                                          <Label className="text-sm mb-1 block">Away Score</Label>
                                          <Select
                                            value={set.awayScore.toString()}
                                            onValueChange={(value) => 
                                              handleSetScoreChange(actualIndex, setIndex, 'away', parseInt(value))
                                            }
                                          >
                                            <SelectTrigger>
                                              <SelectValue placeholder="Score" />
                                      ...
                                      {set.tiebreak && (
                                        <div className="mt-2 pt-2 border-t border-gray-200">
                                          <Label className="text-sm mb-1 block">Tiebreak Scores</Label>
                                          <div className="grid grid-cols-2 gap-4">
                                            <div>
                                              <Input
                                                type="number"
                                                min="0"
                                                placeholder="Home tiebreak"
                                ...
                                <div className="mt-2">
                                  <Label>
                                    <div className="flex items-center space-x-2">
                                      <Checkbox
                                        checked={flight.homePlayerWon}
                                        onCheckedChange={(checked) => {
                                          const newFlights = [...matchFormData.flights];
                                          newFlights[actualIndex].homePlayerWon = checked as boolean;
                                          setMatchFormData({ ...matchFormData, flights: newFlights });
                                        }}
                                      />
                                      <span>Home Player Won</span>
                                    </div>
                                  </Label>
                                </div>
                              </>
                  ...
                  <div>
                    <h3 className="text-lg font-medium mb-4">JV Matches</h3>
                  ...
                  {matchFormData.isComplete && (
                    <div className="mt-4">
                      ...
                      <div className="text-sm text-gray-500 mt-1">
                        This will determine the team winner based on varsity matches
                      </div>
                    </div>
                  )}
                </div>
